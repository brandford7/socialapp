    ...
    <div className="w-full">
      <nav className="flex  items-center justify-between w-full space-y-5  h-20">
        <section className="flex items-center space-x-2 px-5  ">
         ...
         <div className=""></div> <FaSearch className="bg-gray-400  text-2xl border-2 rounded-full p-5 " />
        </section>
        <section className="flex space-x-10 text-2xl mb-5 ">
          ...
          */}
          <FaPlus className="bg-gray-400 text-2xl border-2 rounded-full p-4 hover:bg-blue-500 hover:cursor-pointer" />
          <FaFacebookMessenger className="bg-gray-400 text-2xl border-2 rounded-full p-4 hover:bg-blue-500 hover:cursor-pointer" />
