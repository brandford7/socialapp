    ...
    <div className="w-full ">
      <nav className="flex items-center justify-between space-y-5  h-20">
        <section className="flex items-center space-x-2   ">
          <h2 className="text-yellow-300 shadow-sm text-xl hover:first-letter:to-blue-500">
            Perscogram
          </h2>
          <FaSearch className="bg-gray-200  text-4xl text-black border-2 rounded-full  " />
        </section>
        <section className="flex space-x-2  ">
          ...
          */}
          <FaPlus className="bg-gray-200 text-4xl text-black border-2 rounded-full  hover:bg-blue-500 hover:cursor-pointer" />
          <FaFacebookMessenger className="bg-gray-200 text-4xl text-yellow3-00 border-2 rounded-full  hover:bg-blue-500 hover:cursor-pointer" />
