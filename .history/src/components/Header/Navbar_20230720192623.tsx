      ...
      <nav className="flex  items-center justify-between w-full space-y-5  h-20">
        <section className="flex items-center space-x-2 px-5  ">
          ...
          <FaSearch
            ...
            className="bg-gray-400  text-xl text-red-500 border-2 rounded-full p-2 "
          />
        </section>
        <section className="flex space-x-10 text-2xl mb-5 ">
          ...
          */}
          <FaPlus style={{ color: 'red' }} className="bg-gray-400 text-xl border-2 rounded-full p-4 hover:bg-blue-500 hover:cursor-pointer" />
